...
I_BAR = 1   %Constant Planned Investment                                          5;1;5;1
G_BAR = 2   %Government Expenditure                                               2;2;2;2
G_BAR1= 3   %Government Expenditure                                               9;9;6;3
X_bar = 1   %Export                                                               1;1;8;1
%R     = 1   %Real Exchange Rate
p     = 1   %Price level in home country                                          1,1
pf    = 1   %Price level in foreign country                                      20,1
e     = 1 %Dollar price of foreign exchange                                    1/30,1
b     = 0.4 %High b implies a large reduction in private aggregate demand ,b>0  0.9;0.9;0.9;0.9; 0.9;  0.9; 0.4
i     = [0:0.1:10]; 
c     = 0.57 %Marginal propensity to consume                                     0.8;0.67;0.67;0.67;0.67;0.57; 0.6
m     = 0.001 %Marginal propensity to import                                      0.1;0.9;0.9;0.5;0.1;0.2; 0.001; 0.001
...
%Y_eq    =alfa_g*(c*TR_BAR + I_BAR + G_BAR - b*(1/h)*(k*Y1-(M_bar/P_bar))) % equilibrium level of the Income without changing the government expenditure
%Y_eq_new=alfa_g*(c*TR_BAR + I_BAR + G_BAR1- b*(1/h)*(k*Y11-(M_bar/P_bar))) % equilibrium level of the Income by changing the government expenditure
%*********************************************
%for Y1==Y_eq
%    eq1=Y_eq
%    else
